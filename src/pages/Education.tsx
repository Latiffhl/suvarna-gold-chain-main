    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-16">
        ...
        <div className="container mx-auto px-4 py-12 text-center animate-fade-in">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 text-gray-700 dark:text-gray-300">Pelajari tentang investasi emas digital berbasis blockchain dan cloud computing untuk masa depan finansial yang lebih cerah</p>
        </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                Emas digital adalah aset digital yang nilainya didukung oleh emas fisik. Setiap token atau unit emas digital mewakili kepemilikan sejumlah emas fisik tertentu yang disimpan di fasilitas penyimpanan yang aman.
              </p>
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                Dengan Suvarna, Anda memiliki emas secara digital melalui teknologi blockchain, yang menjamin transparansi, keamanan, dan kemudahan transaksi tanpa perlu menyimpan emas fisik.
              </p>
              <iframe src="https://s.tradingview.com/embed-widget/mini-symbol-overview/?symbol=OANDA%3AXAUUSD&locale=en" width="100%" height="200" frameborder="0"></iframe>
        ...
        <section className="py-16 bg-white dark:bg-navy-500 animate-fade-in" style={{ animationDelay: '200ms' }}>
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                Blockchain adalah teknologi buku besar terdistribusi yang menyimpan data dalam blok-blok yang terhubung dan aman. Dalam konteks emas digital, blockchain menyediakan:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                <div className="flex flex-col items-center p-6 bg-gray-50 dark:bg-navy-600 rounded-xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <p className="text-center text-gray-700 dark:text-gray-300">Data terenkripsi dan tidak bisa diubah, melindungi kepemilikan Anda dari manipulasi.</p>
                </div>

                <div className="flex flex-col items-center p-6 bg-gray-50 dark:bg-navy-600 rounded-xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <Layers className="h-16 w-16 text-amber-500 mb-4 animate-pulse-gold" />
                  <h3 className="text-lg font-semibold mb-2">Transparansi</h3>
                  <p className="text-center text-gray-700 dark:text-gray-300">Semua transaksi tercatat dan dapat diverifikasi oleh siapa saja pada jaringan.</p>
                </div>
              </div>
              ...
              <div className="mt-12 bg-amber-50 dark:bg-navy-700 p-6 rounded-xl border border-amber-200 dark:border-amber-700 transition-all duration-300 hover:shadow-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Suvarna menggunakan smart contract pada blockchain untuk memastikan bahwa setiap token digital yang beredar didukung oleh emas fisik di brankas. Smart contract ini diaudit secara berkala dan terbuka untuk diinspeksi oleh
                  siapapun.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900 animate-fade-in" style={{ animationDelay: '300ms' }}>
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">Cloud computing memungkinkan Suvarna untuk menyediakan layanan yang andal, aman, dan dapat diakses dari mana saja dan kapan saja.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                <div className="flex flex-col items-center p-6 bg-white dark:bg-navy-600 rounded-xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <p className="text-center text-gray-700 dark:text-gray-300">Infrastruktur yang dapat disesuaikan dengan jumlah pengguna dan volume transaksi.</p>
                </div>
                ...
                <div className="flex flex-col items-center p-6 bg-white dark:bg-navy-600 rounded-xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <p className="text-center text-gray-700 dark:text-gray-300">Sistem yang selalu online dengan backup terdistribusi dan perlindungan terhadap bencana.</p>
                </div>
              </div>
              ...
              <div className="mt-12 p-6 border-l-4 border-amber-500 bg-amber-50 dark:bg-navy-700 transition-all duration-300 hover:border-amber-600">
                <p className="italic text-gray-700 dark:text-gray-300">"Kombinasi blockchain dan cloud computing menciptakan fondasi teknologi yang kuat untuk investasi emas digital yang aman, transparan, dan mudah diakses."</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white dark:bg-navy-500 animate-fade-in" style={{ animationDelay: '400ms' }}>
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-3xl mx-auto text-gray-700 dark:text-gray-300">Mulai perjalanan investasi emas digital Anda bersama Suvarna dan nikmati keamanan blockchain dan kemudahan cloud computing.</p>
            <Link to="/#calculator">
              <Button className="btn-primary text-lg px-8 py-6 h-auto transition-all duration-300 hover:scale-105">Simulasi Investasi Sekarang</Button>
            </Link>
          </div>
        </section>
      </div>
